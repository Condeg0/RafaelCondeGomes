...
**Professional Metric:** *Spatial Density Estimation*
**(Code Title: "NYC Map Based on Uber Rides During Apr-2014 to Sep-2014")**
...
* **The "Manhattan Grid":** 90% of liquidity is concentrated in Manhattan (below 59th St) and Downtown Brooklyn.
...
## 2. Circadian Rhythms & Seasonality
**Professional Metric:** *Temporal Volume Distribution*
**(Code Title: "Trips by Hour and Month")**

Demand is not random; it follows a strict human schedule. By stacking hourly volume across six months, we isolate the "invariant" demand curve.

![](hourly_distribution.png)

**Analysis:**
* **The 5:00 PM Spike:** The data reveals a consistent surge beginning at 16:00 and peaking at 17:00-18:00 across all months (April through September).
...
**Professional Metric:** *Day-Hour Heatmap*
**(Code Title: "Heat Map by Hour and Day")**
...
**Professional Metric:** *Base Performance Growth*
**(Code Title: "Trips by Base and Month")**
