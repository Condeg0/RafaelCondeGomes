...
[Profit as a percentage of loan approval rate](LogReg-StrategyCurve.png)
...
* Code Repository: View on GitHub](https://github.com/Condeg0/Loan-Default-Prediction){.btn .btn-primary role="button"}
